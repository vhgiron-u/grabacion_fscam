...
print("cap_1:",cap_1.get(cv2.CAP_PROP_FPS))
...
print("al terminar el programa: cap_1.CAP_PROP_FPS:",cap_1.get(cv2.CAP_PROP_FPS))
...
t_grabacion = t1-t0
frames_totales = len(rets[3])
print("frames capturados:", frames_totales)
print("tiempo de grabacion:", t_grabacion)
print("fps empirico:", frames_totales/t_grabacion)

print("Cantidades finales de frames capturados:")
print({k:Counter(R) for k,R in rets.items()})
